...
from MetaCLIP.open_clip.utils import freeze_batch_norm_2d, to_2tuple
    ...
    def forward(self, x: torch.Tensor, attn_mask: Optional[torch.Tensor] = None):
        ...
        for r in self.resblocks:
            if self.grad_checkpointing and not torch.jit.is_scripting():
                out = checkpoint(r, x, attn_mask)
            else:
                out = r(x, attn_mask=attn_mask)
        ...
        return x if q is None else (x, q, k, v)
