...
from MetaCLIP.open_clip import model as model_zoo
from MetaCLIP.open_clip.model import CLIP, convert_weights_to_fp16, resize_pos_embed
from MetaCLIP.open_clip.openai import load_openai_model
from MetaCLIP.open_clip.pretrained import get_pretrained_url, download_pretrained
from MetaCLIP.open_clip.transform import image_transform
from MetaCLIP.training.checkpoint import load_checkpoint
    ...
    if pretrained.lower() == 'openai':
        ...
        for model_code in os.listdir(f"src/open_clip"):
            if not model_code.endswith("model.py"):
                continue
            module_name = "MetaCLIPopen_clip." + model_code[:-len(".py")]
