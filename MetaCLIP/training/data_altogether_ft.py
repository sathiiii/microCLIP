...
from MetaCLIP.training.distributed import world_info_from_env
from MetaCLIP.training.data import DataInfo
from MetaCLIP.open_clip.transform import _convert_to_rgb
...
class Altogether_FT(torch.utils.data.IterableDataset):
    ...
    def __getitem__(self, idx):
        ...
        with Image.open(rec["img_path"]) as img:
            ...
            from MetaCLIP.training.fb import fairblurbbox
