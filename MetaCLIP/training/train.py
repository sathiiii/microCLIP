...
from MetaCLIP.open_clip.loss import ClipLoss
...
from MetaCLIP.training.checkpoint import save_checkpoint, agg_positions, collect_positions, unwrap_model
...
def build_loss(args):
    from MetaCLIP.open_clip import loss as loss_module
...
def backward(args, total_loss, scaler, optimizer, model):
    if torch.isfinite(total_loss).all():
        if scaler is not None:
            ...
            #    from MetaCLIP.training.detect import detect_unused_parameters
